...
multi-particle final states. It uses [`FourVectors.jl`](https://github.com/JuliaRegistries/General/blob/master/F/FourVectors/Package.toml)
and [`LorentzVectorBase.jl`](https://github.com/JuliaRegistries/General/blob/master/L/LorentzVectorBase/Package.toml) for four-vector storage and operations, and it exposes a single
